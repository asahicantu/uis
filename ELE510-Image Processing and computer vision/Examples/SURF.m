...
plot(ptsOriginal.selectStrongest(20));

figure, imshow(distorted), hold on
plot(ptsDistorted.selectStrongest(20));


%%
% Extract feature descriptors.  
% The method you use for descriptor extraction depends on the class of the input points.
class(ptsOriginal)
